...
"""Auto-generated SBML BioModule wrapper for Sun2019 - Predictive models of aqueous solubility of organic compounds..

Source: biomodels_ebi:MODEL2404220003
Original: https://www.ebi.ac.uk/biomodels/MODEL2404220003
"""
...
class SbmlSun2019PredictiveModelsOfAqueousSolubilityOfOrganic(biosim.BioModule):
    """BioModule wrapper for SBML model: Sun2019 - Predictive models of aqueous solubility of organic compounds.."""

    def __init__(self, model_path: str = "data/MODEL2404220003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sun2019PredictiveModelsOfAqueousSolubilityModel2404220003Model = SbmlSun2019PredictiveModelsOfAqueousSolubilityOfOrganic
