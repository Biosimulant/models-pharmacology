...
"""Auto-generated SBML BioModule wrapper for Singh2006_TCA_Ecoli_acetate.

Source: biomodels_ebi:BIOMD0000000221
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000221
"""
...
class SbmlSingh2006TcaEcoliAcetate(biosim.BioModule):
    """BioModule wrapper for SBML model: Singh2006_TCA_Ecoli_acetate."""

    def __init__(self, model_path: str = "data/BIOMD0000000221.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Singh2006TcaEcoliAcetateBiomd0000000221Model = SbmlSingh2006TcaEcoliAcetate
