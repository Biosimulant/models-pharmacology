...
"""Auto-generated SBML BioModule wrapper for Zake2021 - PBPK model of metformin in mice: single dose intavenous.

Source: biomodels_ebi:BIOMD0000001039
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001039
"""
...
class SbmlZake2021PbpkModelOfMetforminInMiceSingleDose(biosim.BioModule):
    """BioModule wrapper for SBML model: Zake2021 - PBPK model of metformin in mice: single dose intavenous."""

    def __init__(self, model_path: str = "data/BIOMD0000001039.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zake2021PbpkModelOfMetforminInMiceSingleBiomd0000001039Model = SbmlZake2021PbpkModelOfMetforminInMiceSingleDose
