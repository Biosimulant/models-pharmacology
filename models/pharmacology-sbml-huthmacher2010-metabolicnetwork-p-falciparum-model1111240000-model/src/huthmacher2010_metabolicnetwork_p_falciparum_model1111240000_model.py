...
"""Auto-generated SBML BioModule wrapper for Huthmacher2010_MetabolicNetwork_P.falciparum.

Source: biomodels_ebi:MODEL1111240000
Original: https://www.ebi.ac.uk/biomodels/MODEL1111240000
"""
...
class SbmlHuthmacher2010MetabolicnetworkPFalciparum(biosim.BioModule):
    """BioModule wrapper for SBML model: Huthmacher2010_MetabolicNetwork_P.falciparum."""

    def __init__(self, model_path: str = "data/MODEL1111240000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Huthmacher2010MetabolicnetworkPFalciparumModel1111240000Model = SbmlHuthmacher2010MetabolicnetworkPFalciparum
