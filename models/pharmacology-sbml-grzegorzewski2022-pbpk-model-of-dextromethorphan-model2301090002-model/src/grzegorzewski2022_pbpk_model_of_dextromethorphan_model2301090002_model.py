...
"""Auto-generated SBML BioModule wrapper for Grzegorzewski2022 - PBPK model of dextromethorphan.

Source: biomodels_ebi:MODEL2301090002
Original: https://www.ebi.ac.uk/biomodels/MODEL2301090002
"""
...
class SbmlGrzegorzewski2022PbpkModelOfDextromethorphan(biosim.BioModule):
    """BioModule wrapper for SBML model: Grzegorzewski2022 - PBPK model of dextromethorphan."""

    def __init__(self, model_path: str = "data/MODEL2301090002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Grzegorzewski2022PbpkModelOfDextromethorphanModel2301090002Model = SbmlGrzegorzewski2022PbpkModelOfDextromethorphan
