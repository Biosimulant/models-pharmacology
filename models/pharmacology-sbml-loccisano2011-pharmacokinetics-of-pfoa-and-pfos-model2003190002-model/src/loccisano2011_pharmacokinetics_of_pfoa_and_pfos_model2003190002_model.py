...
"""Auto-generated SBML BioModule wrapper for Loccisano2011-pharmacokinetics of PFOA and PFOS in the monkey.

Source: biomodels_ebi:MODEL2003190002
Original: https://www.ebi.ac.uk/biomodels/MODEL2003190002
"""
...
class SbmlLoccisano2011PharmacokineticsOfPfoaAndPfosInThe(biosim.BioModule):
    """BioModule wrapper for SBML model: Loccisano2011-pharmacokinetics of PFOA and PFOS in the monkey."""

    def __init__(self, model_path: str = "data/MODEL2003190002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Loccisano2011PharmacokineticsOfPfoaAndPfosModel2003190002Model = SbmlLoccisano2011PharmacokineticsOfPfoaAndPfosInThe
