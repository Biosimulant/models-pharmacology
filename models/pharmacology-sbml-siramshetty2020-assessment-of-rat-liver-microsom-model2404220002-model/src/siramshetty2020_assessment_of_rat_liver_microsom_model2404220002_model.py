...
"""Auto-generated SBML BioModule wrapper for Siramshetty2020 - Assessment of rat liver microsomal stability with QSAR models..

Source: biomodels_ebi:MODEL2404220002
Original: https://www.ebi.ac.uk/biomodels/MODEL2404220002
"""
...
class SbmlSiramshetty2020AssessmentOfRatLiverMicrosomal(biosim.BioModule):
    """BioModule wrapper for SBML model: Siramshetty2020 - Assessment of rat liver microsomal stability with QSAR models.."""

    def __init__(self, model_path: str = "data/MODEL2404220002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Siramshetty2020AssessmentOfRatLiverMicrosomModel2404220002Model = SbmlSiramshetty2020AssessmentOfRatLiverMicrosomal
