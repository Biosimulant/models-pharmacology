...
"""Auto-generated SBML BioModule wrapper for Pu2019 - eToxPred: an ML-based approach to estimate the toxicity, and synthetic accessibility of drug candidates.

Source: biomodels_ebi:MODEL2406270007
Original: https://www.ebi.ac.uk/biomodels/MODEL2406270007
"""
...
class SbmlPu2019EtoxpredAnMlBasedApproachToEstimateThe(biosim.BioModule):
    """BioModule wrapper for SBML model: Pu2019 - eToxPred: an ML-based approach to estimate the toxicity, and synthetic accessibility of drug candidates."""

    def __init__(self, model_path: str = "data/MODEL2406270007.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pu2019EtoxpredAnMlBasedApproachToEstimateModel2406270007Model = SbmlPu2019EtoxpredAnMlBasedApproachToEstimateThe
