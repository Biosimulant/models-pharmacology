...
"""Auto-generated SBML BioModule wrapper for Elias2025 - Physiologically based pharmacokinetics (PBPK) model glimepiride.

Source: biomodels_ebi:MODEL2510140001
Original: https://www.ebi.ac.uk/biomodels/MODEL2510140001
"""
...
class SbmlElias2025PhysiologicallyBasedPharmacokineticsPbpkModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Elias2025 - Physiologically based pharmacokinetics (PBPK) model glimepiride."""

    def __init__(self, model_path: str = "data/MODEL2510140001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Elias2025PhysiologicallyBasedPharmacokineticsModel2510140001Model = SbmlElias2025PhysiologicallyBasedPharmacokineticsPbpkModel
