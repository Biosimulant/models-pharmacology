...
"""Auto-generated SBML BioModule wrapper for Dahal2022 - Genome-scale metabolic model of Pseudomonas aeruginosa PA14.

Source: biomodels_ebi:MODEL2205090001
Original: https://www.ebi.ac.uk/biomodels/MODEL2205090001
"""
...
class SbmlDahal2022GenomeScaleMetabolicModelOfPseudomonas(biosim.BioModule):
    """BioModule wrapper for SBML model: Dahal2022 - Genome-scale metabolic model of Pseudomonas aeruginosa PA14."""

    def __init__(self, model_path: str = "data/MODEL2205090001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dahal2022GenomeScaleMetabolicModelOfPseudoModel2205090001Model = SbmlDahal2022GenomeScaleMetabolicModelOfPseudomonas
