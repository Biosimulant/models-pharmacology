...
"""Auto-generated SBML BioModule wrapper for Grange2001 - L Dopa PK model.

Source: biomodels_ebi:BIOMD0000000321
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000321
"""
...
class SbmlGrange2001LDopaPkModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Grange2001 - L Dopa PK model."""

    def __init__(self, model_path: str = "data/BIOMD0000000321.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Grange2001LDopaPkModelBiomd0000000321Model = SbmlGrange2001LDopaPkModel
