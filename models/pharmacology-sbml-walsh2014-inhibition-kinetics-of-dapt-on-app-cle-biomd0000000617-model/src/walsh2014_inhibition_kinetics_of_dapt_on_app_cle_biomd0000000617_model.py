...
"""Auto-generated SBML BioModule wrapper for Walsh2014 - Inhibition kinetics of DAPT on APP Cleavage.

Source: biomodels_ebi:BIOMD0000000617
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000617
"""
...
class SbmlWalsh2014InhibitionKineticsOfDaptOnAppCleavage(biosim.BioModule):
    """BioModule wrapper for SBML model: Walsh2014 - Inhibition kinetics of DAPT on APP Cleavage."""

    def __init__(self, model_path: str = "data/BIOMD0000000617.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Walsh2014InhibitionKineticsOfDaptOnAppCleBiomd0000000617Model = SbmlWalsh2014InhibitionKineticsOfDaptOnAppCleavage
