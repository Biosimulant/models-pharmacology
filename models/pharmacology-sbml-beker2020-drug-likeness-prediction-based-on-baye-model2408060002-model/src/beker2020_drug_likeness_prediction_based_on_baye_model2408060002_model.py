...
"""Auto-generated SBML BioModule wrapper for Beker2020 - Drug-likeness prediction based on Bayesian neural networks.

Source: biomodels_ebi:MODEL2408060002
Original: https://www.ebi.ac.uk/biomodels/MODEL2408060002
"""
...
class SbmlBeker2020DrugLikenessPredictionBasedOnBayesianNeural(biosim.BioModule):
    """BioModule wrapper for SBML model: Beker2020 - Drug-likeness prediction based on Bayesian neural networks."""

    def __init__(self, model_path: str = "data/MODEL2408060002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Beker2020DrugLikenessPredictionBasedOnBayeModel2408060002Model = SbmlBeker2020DrugLikenessPredictionBasedOnBayesianNeural
