...
"""Auto-generated SBML BioModule wrapper for Maldonado2017 - Integration of Genome Scale Metabolic Networks and Gene Regulation of Metabolic Enzymes With Physiologically Based Pharmacokinetics.

Source: biomodels_ebi:MODEL2111050001
Original: https://www.ebi.ac.uk/biomodels/MODEL2111050001
"""
...
class SbmlMaldonado2017IntegrationOfGenomeScaleMetabolic(biosim.BioModule):
    """BioModule wrapper for SBML model: Maldonado2017 - Integration of Genome Scale Metabolic Networks and Gene Regulation of Metabolic Enzymes With Physiologically Based Pharmacokinetics."""

    def __init__(self, model_path: str = "data/MODEL2111050001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Maldonado2017IntegrationOfGenomeScaleMetaboModel2111050001Model = SbmlMaldonado2017IntegrationOfGenomeScaleMetabolic
