...
"""Auto-generated SBML BioModule wrapper for Shao2022 - S2DV: converting SMILES to a drug vector for predicting the activity of anti-HBV small molecules.

Source: biomodels_ebi:MODEL2406040001
Original: https://www.ebi.ac.uk/biomodels/MODEL2406040001
"""
...
class SbmlShao2022S2dvConvertingSmilesToADrugVectorFor(biosim.BioModule):
    """BioModule wrapper for SBML model: Shao2022 - S2DV: converting SMILES to a drug vector for predicting the activity of anti-HBV small molecules."""

    def __init__(self, model_path: str = "data/MODEL2406040001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Shao2022S2dvConvertingSmilesToADrugVectorModel2406040001Model = SbmlShao2022S2dvConvertingSmilesToADrugVectorFor
