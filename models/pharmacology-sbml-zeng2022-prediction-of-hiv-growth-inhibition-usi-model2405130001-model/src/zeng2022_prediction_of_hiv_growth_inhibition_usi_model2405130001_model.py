...
"""Auto-generated SBML BioModule wrapper for Zeng2022 - Prediction of HIV Growth Inhibition using ImageMol.

Source: biomodels_ebi:MODEL2405130001
Original: https://www.ebi.ac.uk/biomodels/MODEL2405130001
"""
...
class SbmlZeng2022PredictionOfHivGrowthInhibitionUsingImagemol(biosim.BioModule):
    """BioModule wrapper for SBML model: Zeng2022 - Prediction of HIV Growth Inhibition using ImageMol."""

    def __init__(self, model_path: str = "data/MODEL2405130001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zeng2022PredictionOfHivGrowthInhibitionUsiModel2405130001Model = SbmlZeng2022PredictionOfHivGrowthInhibitionUsingImagemol
