...
"""Auto-generated SBML BioModule wrapper for Simon2019 - NIK-dependent p100 processing into p52, Michaelis-Menten, SBML 2v4.

Source: biomodels_ebi:BIOMD0000000866
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000866
"""
...
class SbmlSimon2019NikDependentP100ProcessingIntoP52Michaelis(biosim.BioModule):
    """BioModule wrapper for SBML model: Simon2019 - NIK-dependent p100 processing into p52, Michaelis-Menten, SBML 2v4."""

    def __init__(self, model_path: str = "data/BIOMD0000000866.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Simon2019NikDependentP100ProcessingIntoP52Biomd0000000866Model = SbmlSimon2019NikDependentP100ProcessingIntoP52Michaelis
