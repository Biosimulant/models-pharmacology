...
"""Auto-generated SBML BioModule wrapper for Zeng2022 - Prediction of molecular properties and drug targets using a self-supervised learning framework.

Source: biomodels_ebi:MODEL2405080005
Original: https://www.ebi.ac.uk/biomodels/MODEL2405080005
"""
...
class SbmlZeng2022PredictionOfMolecularPropertiesAndDrug(biosim.BioModule):
    """BioModule wrapper for SBML model: Zeng2022 - Prediction of molecular properties and drug targets using a self-supervised learning framework."""

    def __init__(self, model_path: str = "data/MODEL2405080005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zeng2022PredictionOfMolecularPropertiesAndModel2405080005Model = SbmlZeng2022PredictionOfMolecularPropertiesAndDrug
