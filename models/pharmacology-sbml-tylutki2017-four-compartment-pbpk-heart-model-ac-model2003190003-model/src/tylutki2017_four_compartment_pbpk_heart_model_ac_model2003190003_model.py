...
"""Auto-generated SBML BioModule wrapper for Tylutki2017-four-compartment PBPK heart model accounting for cardiac metabolism.

Source: biomodels_ebi:MODEL2003190003
Original: https://www.ebi.ac.uk/biomodels/MODEL2003190003
"""
...
class SbmlTylutki2017FourCompartmentPbpkHeartModelAccounting(biosim.BioModule):
    """BioModule wrapper for SBML model: Tylutki2017-four-compartment PBPK heart model accounting for cardiac metabolism."""

    def __init__(self, model_path: str = "data/MODEL2003190003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tylutki2017FourCompartmentPbpkHeartModelAcModel2003190003Model = SbmlTylutki2017FourCompartmentPbpkHeartModelAccounting
