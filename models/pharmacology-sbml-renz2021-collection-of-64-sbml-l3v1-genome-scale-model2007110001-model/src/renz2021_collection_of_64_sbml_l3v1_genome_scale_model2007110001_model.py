...
"""Auto-generated SBML BioModule wrapper for Renz2021 -  Collection of 64 SBML L3V1 genome-scale metabolic models (FBC Version 2) of Staphylococcus aureus.

Source: biomodels_ebi:MODEL2007110001
Original: https://www.ebi.ac.uk/biomodels/MODEL2007110001
"""
...
class SbmlRenz2021CollectionOf64SbmlL3v1GenomeScaleMetabolic(biosim.BioModule):
    """BioModule wrapper for SBML model: Renz2021 -  Collection of 64 SBML L3V1 genome-scale metabolic models (FBC Version 2) of Staphylococcus aureus."""

    def __init__(self, model_path: str = "data/MODEL2007110001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Renz2021CollectionOf64SbmlL3v1GenomeScaleModel2007110001Model = SbmlRenz2021CollectionOf64SbmlL3v1GenomeScaleMetabolic
