...
"""Auto-generated SBML BioModule wrapper for KaratzaKaralis2020 - CYP mediated losartan metabolism.

Source: biomodels_ebi:MODEL2412180001
Original: https://www.ebi.ac.uk/biomodels/MODEL2412180001
"""
...
class SbmlKaratzakaralis2020CypMediatedLosartanMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: KaratzaKaralis2020 - CYP mediated losartan metabolism."""

    def __init__(self, model_path: str = "data/MODEL2412180001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Karatzakaralis2020CypMediatedLosartanMetabolModel2412180001Model = SbmlKaratzakaralis2020CypMediatedLosartanMetabolism
