...
"""Auto-generated SBML BioModule wrapper for Peng2013-melatonin--effects of light and routes of administration.

Source: biomodels_ebi:MODEL2003190006
Original: https://www.ebi.ac.uk/biomodels/MODEL2003190006
"""
...
class SbmlPeng2013MelatoninEffectsOfLightAndRoutesOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Peng2013-melatonin--effects of light and routes of administration."""

    def __init__(self, model_path: str = "data/MODEL2003190006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Peng2013MelatoninEffectsOfLightAndRoutesOModel2003190006Model = SbmlPeng2013MelatoninEffectsOfLightAndRoutesOf
