...
"""Auto-generated SBML BioModule wrapper for Kraan199_Kinetics of Cortisol Metabolism and Excretion..

Source: biomodels_ebi:BIOMD0000000916
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000916
"""
...
class SbmlKraan199KineticsOfCortisolMetabolismAndExcretion(biosim.BioModule):
    """BioModule wrapper for SBML model: Kraan199_Kinetics of Cortisol Metabolism and Excretion.."""

    def __init__(self, model_path: str = "data/BIOMD0000000916.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kraan199KineticsOfCortisolMetabolismAndExcBiomd0000000916Model = SbmlKraan199KineticsOfCortisolMetabolismAndExcretion
