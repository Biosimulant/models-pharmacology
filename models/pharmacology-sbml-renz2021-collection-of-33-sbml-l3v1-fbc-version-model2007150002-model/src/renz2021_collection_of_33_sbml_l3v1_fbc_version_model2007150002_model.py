...
"""Auto-generated SBML BioModule wrapper for Renz2021 - Collection of 33 SBML L3V1 (FBC Version 2) models of Staphylococcus aureus by the Path2Models project 2013.

Source: biomodels_ebi:MODEL2007150002
Original: https://www.ebi.ac.uk/biomodels/MODEL2007150002
"""
...
class SbmlRenz2021CollectionOf33SbmlL3v1FbcVersion2ModelsOf(bsim.BioModule):
    ...
    def __init__(self, model_path: str = "data/MODEL2007150002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Renz2021CollectionOf33SbmlL3v1FbcVersionModel2007150002Model = SbmlRenz2021CollectionOf33SbmlL3v1FbcVersion2ModelsOf
