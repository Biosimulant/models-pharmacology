...
"""Auto-generated SBML BioModule wrapper for Sier2017_estrogen_PBPK_GSMN.

Source: biomodels_ebi:MODEL1711210003
Original: https://www.ebi.ac.uk/biomodels/MODEL1711210003
"""
...
class SbmlSier2017EstrogenPbpkGsmn(biosim.BioModule):
    """BioModule wrapper for SBML model: Sier2017_estrogen_PBPK_GSMN."""

    def __init__(self, model_path: str = "data/MODEL1711210003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sier2017EstrogenPbpkGsmnModel1711210003Model = SbmlSier2017EstrogenPbpkGsmn
