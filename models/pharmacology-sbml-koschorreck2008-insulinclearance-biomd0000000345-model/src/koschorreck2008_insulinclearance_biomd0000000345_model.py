...
"""Auto-generated SBML BioModule wrapper for Koschorreck2008_InsulinClearance.

Source: biomodels_ebi:BIOMD0000000345
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000345
"""
...
class SbmlKoschorreck2008Insulinclearance(biosim.BioModule):
    """BioModule wrapper for SBML model: Koschorreck2008_InsulinClearance."""

    def __init__(self, model_path: str = "data/BIOMD0000000345.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koschorreck2008InsulinclearanceBiomd0000000345Model = SbmlKoschorreck2008Insulinclearance
