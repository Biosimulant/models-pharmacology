...
"""Auto-generated SBML BioModule wrapper for Grignard2022 - Detyrosination/Tyrosination Model in neurons and proliferative cells.

Source: biomodels_ebi:MODEL2209260001
Original: https://www.ebi.ac.uk/biomodels/MODEL2209260001
"""
...
class SbmlGrignard2022DetyrosinationTyrosinationModelInNeurons(biosim.BioModule):
    """BioModule wrapper for SBML model: Grignard2022 - Detyrosination/Tyrosination Model in neurons and proliferative cells."""

    def __init__(self, model_path: str = "data/MODEL2209260001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Grignard2022DetyrosinationTyrosinationModelIModel2209260001Model = SbmlGrignard2022DetyrosinationTyrosinationModelInNeurons
