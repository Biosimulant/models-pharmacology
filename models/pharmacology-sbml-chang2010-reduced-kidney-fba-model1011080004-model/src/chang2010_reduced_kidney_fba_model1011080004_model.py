...
"""Auto-generated SBML BioModule wrapper for Chang2010_Reduced_Kidney_FBA.

Source: biomodels_ebi:MODEL1011080004
Original: https://www.ebi.ac.uk/biomodels/MODEL1011080004
"""
...
class SbmlChang2010ReducedKidneyFba(biosim.BioModule):
    """BioModule wrapper for SBML model: Chang2010_Reduced_Kidney_FBA."""

    def __init__(self, model_path: str = "data/MODEL1011080004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chang2010ReducedKidneyFbaModel1011080004Model = SbmlChang2010ReducedKidneyFba
