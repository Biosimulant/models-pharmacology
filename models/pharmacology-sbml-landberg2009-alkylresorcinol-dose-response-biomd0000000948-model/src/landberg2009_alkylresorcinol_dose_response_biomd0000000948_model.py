...
"""Auto-generated SBML BioModule wrapper for Landberg2009 - Alkylresorcinol Dose Response.

Source: biomodels_ebi:BIOMD0000000948
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000948
"""
...
class SbmlLandberg2009AlkylresorcinolDoseResponse(biosim.BioModule):
    """BioModule wrapper for SBML model: Landberg2009 - Alkylresorcinol Dose Response."""

    def __init__(self, model_path: str = "data/BIOMD0000000948.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Landberg2009AlkylresorcinolDoseResponseBiomd0000000948Model = SbmlLandberg2009AlkylresorcinolDoseResponse
