...
"""Auto-generated SBML BioModule wrapper for Shi1993_Caffeine_pressor_tolerance.

Source: biomodels_ebi:BIOMD0000000241
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000241
"""
...
class SbmlShi1993CaffeinePressorTolerance(biosim.BioModule):
    """BioModule wrapper for SBML model: Shi1993_Caffeine_pressor_tolerance."""

    def __init__(self, model_path: str = "data/BIOMD0000000241.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Shi1993CaffeinePressorToleranceBiomd0000000241Model = SbmlShi1993CaffeinePressorTolerance
