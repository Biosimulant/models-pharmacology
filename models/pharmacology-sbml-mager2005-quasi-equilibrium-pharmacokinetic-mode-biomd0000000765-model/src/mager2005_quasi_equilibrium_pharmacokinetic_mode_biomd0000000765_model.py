...
"""Auto-generated SBML BioModule wrapper for Mager2005 - Quasi-equilibrium pharmacokinetic model for drugs exhibiting target-mediated drug disposition.

Source: biomodels_ebi:BIOMD0000000765
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000765
"""
...
class SbmlMager2005QuasiEquilibriumPharmacokineticModelForDrugs(biosim.BioModule):
    """BioModule wrapper for SBML model: Mager2005 - Quasi-equilibrium pharmacokinetic model for drugs exhibiting target-mediated drug disposition."""

    def __init__(self, model_path: str = "data/BIOMD0000000765.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mager2005QuasiEquilibriumPharmacokineticModeBiomd0000000765Model = SbmlMager2005QuasiEquilibriumPharmacokineticModelForDrugs
