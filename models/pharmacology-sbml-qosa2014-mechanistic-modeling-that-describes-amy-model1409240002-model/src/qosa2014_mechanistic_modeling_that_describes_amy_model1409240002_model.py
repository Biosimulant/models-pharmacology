...
"""Auto-generated SBML BioModule wrapper for Qosa2014 - Mechanistic modeling that describes amyloid-Beta clearance across BBB.

Source: biomodels_ebi:MODEL1409240002
Original: https://www.ebi.ac.uk/biomodels/MODEL1409240002
"""
...
class SbmlQosa2014MechanisticModelingThatDescribesAmyloidBeta(biosim.BioModule):
    """BioModule wrapper for SBML model: Qosa2014 - Mechanistic modeling that describes amyloid-Beta clearance across BBB."""

    def __init__(self, model_path: str = "data/MODEL1409240002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Qosa2014MechanisticModelingThatDescribesAmyModel1409240002Model = SbmlQosa2014MechanisticModelingThatDescribesAmyloidBeta
