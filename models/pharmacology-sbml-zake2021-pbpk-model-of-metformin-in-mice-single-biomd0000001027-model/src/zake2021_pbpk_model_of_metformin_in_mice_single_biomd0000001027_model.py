...
"""Auto-generated SBML BioModule wrapper for Zake2021 - PBPK model of metformin in mice: single dose peroral.

Source: biomodels_ebi:BIOMD0000001027
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001027
"""
...
class SbmlZake2021PbpkModelOfMetforminInMiceSingleDosePeroral(biosim.BioModule):
    """BioModule wrapper for SBML model: Zake2021 - PBPK model of metformin in mice: single dose peroral."""

    def __init__(self, model_path: str = "data/BIOMD0000001027.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zake2021PbpkModelOfMetforminInMiceSingleBiomd0000001027Model = SbmlZake2021PbpkModelOfMetforminInMiceSingleDosePeroral
