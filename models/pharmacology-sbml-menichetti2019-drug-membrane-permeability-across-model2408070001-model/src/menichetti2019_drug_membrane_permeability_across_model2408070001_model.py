...
"""Auto-generated SBML BioModule wrapper for Menichetti2019 - Drug−Membrane Permeability across Chemical Space.

Source: biomodels_ebi:MODEL2408070001
Original: https://www.ebi.ac.uk/biomodels/MODEL2408070001
"""
...
class SbmlMenichetti2019DrugmembranePermeabilityAcrossChemical(biosim.BioModule):
    """BioModule wrapper for SBML model: Menichetti2019 - Drug−Membrane Permeability across Chemical Space."""

    def __init__(self, model_path: str = "data/MODEL2408070001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Menichetti2019DrugMembranePermeabilityAcrossModel2408070001Model = SbmlMenichetti2019DrugmembranePermeabilityAcrossChemical
