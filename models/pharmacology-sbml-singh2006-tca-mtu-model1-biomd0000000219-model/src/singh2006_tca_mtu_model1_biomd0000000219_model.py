...
"""Auto-generated SBML BioModule wrapper for Singh2006_TCA_mtu_model1.

Source: biomodels_ebi:BIOMD0000000219
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000219
"""
...
class SbmlSingh2006TcaMtuModel1(biosim.BioModule):
    """BioModule wrapper for SBML model: Singh2006_TCA_mtu_model1."""

    def __init__(self, model_path: str = "data/BIOMD0000000219.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Singh2006TcaMtuModel1Biomd0000000219Model = SbmlSingh2006TcaMtuModel1
