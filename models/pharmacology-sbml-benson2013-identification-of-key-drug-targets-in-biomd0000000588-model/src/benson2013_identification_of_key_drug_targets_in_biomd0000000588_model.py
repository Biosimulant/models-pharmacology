...
"""Auto-generated SBML BioModule wrapper for Benson2013 - Identification of key drug targets in nerve growth factor pathway.

Source: biomodels_ebi:BIOMD0000000588
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000588
"""
...
class SbmlBenson2013IdentificationOfKeyDrugTargetsInNerve(biosim.BioModule):
    """BioModule wrapper for SBML model: Benson2013 - Identification of key drug targets in nerve growth factor pathway."""

    def __init__(self, model_path: str = "data/BIOMD0000000588.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Benson2013IdentificationOfKeyDrugTargetsInBiomd0000000588Model = SbmlBenson2013IdentificationOfKeyDrugTargetsInNerve
