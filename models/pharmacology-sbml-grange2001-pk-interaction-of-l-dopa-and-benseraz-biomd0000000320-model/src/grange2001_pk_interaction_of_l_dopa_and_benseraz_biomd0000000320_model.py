...
"""Auto-generated SBML BioModule wrapper for Grange2001 - PK interaction of L-dopa and benserazide.

Source: biomodels_ebi:BIOMD0000000320
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000320
"""
...
class SbmlGrange2001PkInteractionOfLDopaAndBenserazide(biosim.BioModule):
    """BioModule wrapper for SBML model: Grange2001 - PK interaction of L-dopa and benserazide."""

    def __init__(self, model_path: str = "data/BIOMD0000000320.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Grange2001PkInteractionOfLDopaAndBenserazBiomd0000000320Model = SbmlGrange2001PkInteractionOfLDopaAndBenserazide
