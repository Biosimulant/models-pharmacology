...
"""Auto-generated SBML BioModule wrapper for Petrov2018 - C-547 a 6-methyluracil derivative with long-lasting binding and rebinding on acetylcholinesterase.

Source: biomodels_ebi:MODEL1910240001
Original: https://www.ebi.ac.uk/biomodels/MODEL1910240001
"""
...
class SbmlPetrov2018C547A6MethyluracilDerivativeWithLong(biosim.BioModule):
    """BioModule wrapper for SBML model: Petrov2018 - C-547 a 6-methyluracil derivative with long-lasting binding and rebinding on acetylcholinesterase."""

    def __init__(self, model_path: str = "data/MODEL1910240001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Petrov2018C547A6MethyluracilDerivativeWitModel1910240001Model = SbmlPetrov2018C547A6MethyluracilDerivativeWithLong
