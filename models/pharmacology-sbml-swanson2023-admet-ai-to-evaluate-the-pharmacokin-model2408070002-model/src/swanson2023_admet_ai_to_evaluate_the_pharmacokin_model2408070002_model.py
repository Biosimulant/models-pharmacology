...
"""Auto-generated SBML BioModule wrapper for Swanson2023 - ADMET-AI: To evaluate the pharmacokinetics property of large-scale chemical libraries.

Source: biomodels_ebi:MODEL2408070002
Original: https://www.ebi.ac.uk/biomodels/MODEL2408070002
"""
...
class SbmlSwanson2023AdmetAiToEvaluateThePharmacokinetics(biosim.BioModule):
    """BioModule wrapper for SBML model: Swanson2023 - ADMET-AI: To evaluate the pharmacokinetics property of large-scale chemical libraries."""

    def __init__(self, model_path: str = "data/MODEL2408070002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Swanson2023AdmetAiToEvaluateThePharmacokinModel2408070002Model = SbmlSwanson2023AdmetAiToEvaluateThePharmacokinetics
