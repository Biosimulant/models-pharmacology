...
"""Auto-generated SBML BioModule wrapper for Koeller2021 - PBPK model of ICG liver function tests.

Source: biomodels_ebi:MODEL2301090001
Original: https://www.ebi.ac.uk/biomodels/MODEL2301090001
"""
...
class SbmlKoeller2021PbpkModelOfIcgLiverFunctionTests(biosim.BioModule):
    """BioModule wrapper for SBML model: Koeller2021 - PBPK model of ICG liver function tests."""

    def __init__(self, model_path: str = "data/MODEL2301090001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koeller2021PbpkModelOfIcgLiverFunctionTesModel2301090001Model = SbmlKoeller2021PbpkModelOfIcgLiverFunctionTests
