...
"""Auto-generated SBML BioModule wrapper for Ertl2009 - Synthetic accessibility score estimation.

Source: biomodels_ebi:MODEL2407180004
Original: https://www.ebi.ac.uk/biomodels/MODEL2407180004
"""
...
class SbmlErtl2009SyntheticAccessibilityScoreEstimation(biosim.BioModule):
    """BioModule wrapper for SBML model: Ertl2009 - Synthetic accessibility score estimation."""

    def __init__(self, model_path: str = "data/MODEL2407180004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ertl2009SyntheticAccessibilityScoreEstimatioModel2407180004Model = SbmlErtl2009SyntheticAccessibilityScoreEstimation
