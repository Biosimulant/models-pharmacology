...
"""Auto-generated SBML BioModule wrapper for Demin2013 - PKPD behaviour - 5-Lipoxygenase inhibitors.

Source: biomodels_ebi:BIOMD0000000490
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000490
"""
...
class SbmlDemin2013PkpdBehaviour5LipoxygenaseInhibitors(biosim.BioModule):
    """BioModule wrapper for SBML model: Demin2013 - PKPD behaviour - 5-Lipoxygenase inhibitors."""

    def __init__(self, model_path: str = "data/BIOMD0000000490.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Demin2013PkpdBehaviour5LipoxygenaseInhibitoBiomd0000000490Model = SbmlDemin2013PkpdBehaviour5LipoxygenaseInhibitors
