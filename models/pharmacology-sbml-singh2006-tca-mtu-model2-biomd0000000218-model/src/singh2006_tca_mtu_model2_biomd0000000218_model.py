...
"""Auto-generated SBML BioModule wrapper for Singh2006_TCA_mtu_model2.

Source: biomodels_ebi:BIOMD0000000218
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000218
"""
...
class SbmlSingh2006TcaMtuModel2(biosim.BioModule):
    """BioModule wrapper for SBML model: Singh2006_TCA_mtu_model2."""

    def __init__(self, model_path: str = "data/BIOMD0000000218.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Singh2006TcaMtuModel2Biomd0000000218Model = SbmlSingh2006TcaMtuModel2
