...
"""Auto-generated SBML BioModule wrapper for Zake2021 - PBPK model of metformin in humans, single PO dose.

Source: biomodels_ebi:BIOMD0000001028
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001028
"""
...
class SbmlZake2021PbpkModelOfMetforminInHumansSinglePoDose(biosim.BioModule):
    """BioModule wrapper for SBML model: Zake2021 - PBPK model of metformin in humans, single PO dose."""

    def __init__(self, model_path: str = "data/BIOMD0000001028.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zake2021PbpkModelOfMetforminInHumansSinglBiomd0000001028Model = SbmlZake2021PbpkModelOfMetforminInHumansSinglePoDose
