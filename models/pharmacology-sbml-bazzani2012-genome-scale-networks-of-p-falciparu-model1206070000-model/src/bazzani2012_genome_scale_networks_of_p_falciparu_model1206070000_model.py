...
"""Auto-generated SBML BioModule wrapper for Bazzani2012 - Genome scale networks of P.falciparum and human hepatocyte.

Source: biomodels_ebi:MODEL1206070000
Original: https://www.ebi.ac.uk/biomodels/MODEL1206070000
"""
...
class SbmlBazzani2012GenomeScaleNetworksOfPFalciparumAndHuman(biosim.BioModule):
    """BioModule wrapper for SBML model: Bazzani2012 - Genome scale networks of P.falciparum and human hepatocyte."""

    def __init__(self, model_path: str = "data/MODEL1206070000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bazzani2012GenomeScaleNetworksOfPFalciparuModel1206070000Model = SbmlBazzani2012GenomeScaleNetworksOfPFalciparumAndHuman
