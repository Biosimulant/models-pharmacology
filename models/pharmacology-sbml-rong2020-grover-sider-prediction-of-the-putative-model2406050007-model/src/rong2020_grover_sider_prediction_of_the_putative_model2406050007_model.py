...
"""Auto-generated SBML BioModule wrapper for Rong2020 - Grover-sider: Prediction of the putative adverse drug reactions (ADR) of a molecule.

Source: biomodels_ebi:MODEL2406050007
Original: https://www.ebi.ac.uk/biomodels/MODEL2406050007
"""
...
class SbmlRong2020GroverSiderPredictionOfThePutativeAdverse(biosim.BioModule):
    """BioModule wrapper for SBML model: Rong2020 - Grover-sider: Prediction of the putative adverse drug reactions (ADR) of a molecule."""

    def __init__(self, model_path: str = "data/MODEL2406050007.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rong2020GroverSiderPredictionOfThePutativeModel2406050007Model = SbmlRong2020GroverSiderPredictionOfThePutativeAdverse
