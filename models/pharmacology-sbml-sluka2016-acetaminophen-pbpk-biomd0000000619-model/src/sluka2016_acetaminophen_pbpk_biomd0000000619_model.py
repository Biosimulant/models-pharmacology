...
"""Auto-generated SBML BioModule wrapper for Sluka2016  - Acetaminophen PBPK.

Source: biomodels_ebi:BIOMD0000000619
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000619
"""
...
class SbmlSluka2016AcetaminophenPbpk(biosim.BioModule):
    """BioModule wrapper for SBML model: Sluka2016  - Acetaminophen PBPK."""

    def __init__(self, model_path: str = "data/BIOMD0000000619.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sluka2016AcetaminophenPbpkBiomd0000000619Model = SbmlSluka2016AcetaminophenPbpk
