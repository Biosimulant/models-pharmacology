...
"""Auto-generated SBML BioModule wrapper for Tabak2007_dopamine.

Source: biomodels_ebi:BIOMD0000000138
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000138
"""
...
class SbmlTabak2007Dopamine(biosim.BioModule):
    """BioModule wrapper for SBML model: Tabak2007_dopamine."""

    def __init__(self, model_path: str = "data/BIOMD0000000138.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tabak2007DopamineBiomd0000000138Model = SbmlTabak2007Dopamine
