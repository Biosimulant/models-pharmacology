...
"""Auto-generated SBML BioModule wrapper for Shah2020 - Predicting Human Liver Microsomal Stability of small molecules.

Source: biomodels_ebi:MODEL2405130005
Original: https://www.ebi.ac.uk/biomodels/MODEL2405130005
"""
...
class SbmlShah2020PredictingHumanLiverMicrosomalStabilityOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Shah2020 - Predicting Human Liver Microsomal Stability of small molecules."""

    def __init__(self, model_path: str = "data/MODEL2405130005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Shah2020PredictingHumanLiverMicrosomalStabiModel2405130005Model = SbmlShah2020PredictingHumanLiverMicrosomalStabilityOf
