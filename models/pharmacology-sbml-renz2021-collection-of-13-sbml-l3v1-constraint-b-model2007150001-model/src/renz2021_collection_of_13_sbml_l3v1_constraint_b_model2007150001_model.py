...
"""Auto-generated SBML BioModule wrapper for Renz2021 -  Collection of 13 SBML L3V1 constraint-based models (FBC Version 2) of Staphylococcus aureus.

Source: biomodels_ebi:MODEL2007150001
Original: https://www.ebi.ac.uk/biomodels/MODEL2007150001
"""
...
class SbmlRenz2021CollectionOf13SbmlL3v1ConstraintBasedModels(biosim.BioModule):
    """BioModule wrapper for SBML model: Renz2021 -  Collection of 13 SBML L3V1 constraint-based models (FBC Version 2) of Staphylococcus aureus."""

    def __init__(self, model_path: str = "data/MODEL2007150001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Renz2021CollectionOf13SbmlL3v1ConstraintBModel2007150001Model = SbmlRenz2021CollectionOf13SbmlL3v1ConstraintBasedModels
