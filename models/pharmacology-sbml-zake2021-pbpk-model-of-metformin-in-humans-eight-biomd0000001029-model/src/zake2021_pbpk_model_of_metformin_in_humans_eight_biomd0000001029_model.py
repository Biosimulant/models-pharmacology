...
"""Auto-generated SBML BioModule wrapper for Zake2021 - PBPK model of metformin in humans, eight PO administrations with 12h interval.

Source: biomodels_ebi:BIOMD0000001029
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001029
"""
...
class SbmlZake2021PbpkModelOfMetforminInHumansEightPo(biosim.BioModule):
    """BioModule wrapper for SBML model: Zake2021 - PBPK model of metformin in humans, eight PO administrations with 12h interval."""

    def __init__(self, model_path: str = "data/BIOMD0000001029.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zake2021PbpkModelOfMetforminInHumansEightBiomd0000001029Model = SbmlZake2021PbpkModelOfMetforminInHumansEightPo
