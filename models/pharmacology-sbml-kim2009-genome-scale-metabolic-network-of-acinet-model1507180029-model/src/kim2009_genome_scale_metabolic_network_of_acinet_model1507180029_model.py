...
"""Auto-generated SBML BioModule wrapper for Kim2009 - Genome-scale metabolic network of Acinetobacter baumannii (AbyMBEL891).

Source: biomodels_ebi:MODEL1507180029
Original: https://www.ebi.ac.uk/biomodels/MODEL1507180029
"""
...
class SbmlKim2009GenomeScaleMetabolicNetworkOfAcinetobacter(biosim.BioModule):
    """BioModule wrapper for SBML model: Kim2009 - Genome-scale metabolic network of Acinetobacter baumannii (AbyMBEL891)."""

    def __init__(self, model_path: str = "data/MODEL1507180029.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kim2009GenomeScaleMetabolicNetworkOfAcinetModel1507180029Model = SbmlKim2009GenomeScaleMetabolicNetworkOfAcinetobacter
