...
"""Auto-generated SBML BioModule wrapper for DoldánMartelli2013 - A Mathematical Model for the Rational Design of Chimeric Ligands in Selective Drug Therapies.

Source: biomodels_ebi:MODEL1907310001
Original: https://www.ebi.ac.uk/biomodels/MODEL1907310001
"""
...
class SbmlDoldanmartelli2013AMathematicalModelForTheRational(biosim.BioModule):
    """BioModule wrapper for SBML model: DoldánMartelli2013 - A Mathematical Model for the Rational Design of Chimeric Ligands in Selective Drug Therapies."""

    def __init__(self, model_path: str = "data/MODEL1907310001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DoldNmartelli2013AMathematicalModelForTheModel1907310001Model = SbmlDoldanmartelli2013AMathematicalModelForTheRational
