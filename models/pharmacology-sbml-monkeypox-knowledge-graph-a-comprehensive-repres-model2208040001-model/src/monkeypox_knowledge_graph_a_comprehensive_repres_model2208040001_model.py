...
"""Auto-generated SBML BioModule wrapper for Monkeypox Knowledge Graph: A comprehensive representation embedding chemical entities and associated biology of Monkeypox.

Source: biomodels_ebi:MODEL2208040001
Original: https://www.ebi.ac.uk/biomodels/MODEL2208040001
"""
...
class SbmlMonkeypoxKnowledgeGraphAComprehensiveRepresentation(biosim.BioModule):
    """BioModule wrapper for SBML model: Monkeypox Knowledge Graph: A comprehensive representation embedding chemical entities and associated biology of Monkeypox."""

    def __init__(self, model_path: str = "data/MODEL2208040001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MonkeypoxKnowledgeGraphAComprehensiveRepresModel2208040001Model = SbmlMonkeypoxKnowledgeGraphAComprehensiveRepresentation
