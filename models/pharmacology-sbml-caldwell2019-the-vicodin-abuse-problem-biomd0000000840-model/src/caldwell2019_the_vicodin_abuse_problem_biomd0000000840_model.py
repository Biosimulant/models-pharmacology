...
"""Auto-generated SBML BioModule wrapper for Caldwell2019 - The Vicodin abuse problem.

Source: biomodels_ebi:BIOMD0000000840
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000840
"""
...
class SbmlCaldwell2019TheVicodinAbuseProblem(biosim.BioModule):
    """BioModule wrapper for SBML model: Caldwell2019 - The Vicodin abuse problem."""

    def __init__(self, model_path: str = "data/BIOMD0000000840.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Caldwell2019TheVicodinAbuseProblemBiomd0000000840Model = SbmlCaldwell2019TheVicodinAbuseProblem
