...
"""Auto-generated SBML BioModule wrapper for Strasen2018 - TGFb SMAD Signalling - Dose dependent dynamics upon TGFb stimulation.

Source: biomodels_ebi:BIOMD0000000989
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000989
"""
...
class SbmlStrasen2018TgfbSmadSignallingDoseDependentDynamics(biosim.BioModule):
    """BioModule wrapper for SBML model: Strasen2018 - TGFb SMAD Signalling - Dose dependent dynamics upon TGFb stimulation."""

    def __init__(self, model_path: str = "data/BIOMD0000000989.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Strasen2018TgfbSmadSignallingDoseDependentBiomd0000000989Model = SbmlStrasen2018TgfbSmadSignallingDoseDependentDynamics
