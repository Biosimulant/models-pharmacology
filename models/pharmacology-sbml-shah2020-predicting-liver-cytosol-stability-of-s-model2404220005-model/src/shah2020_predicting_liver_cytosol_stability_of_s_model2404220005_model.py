...
"""Auto-generated SBML BioModule wrapper for Shah2020 - Predicting liver cytosol stability of small molecules..

Source: biomodels_ebi:MODEL2404220005
Original: https://www.ebi.ac.uk/biomodels/MODEL2404220005
"""
...
class SbmlShah2020PredictingLiverCytosolStabilityOfSmall(biosim.BioModule):
    """BioModule wrapper for SBML model: Shah2020 - Predicting liver cytosol stability of small molecules.."""

    def __init__(self, model_path: str = "data/MODEL2404220005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Shah2020PredictingLiverCytosolStabilityOfSModel2404220005Model = SbmlShah2020PredictingLiverCytosolStabilityOfSmall
