...
"""Tellurium-backed SBML BioModule for Zake2021 - PBPK model of metformin in humans, eight PO administrations with 12h interval."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Zake2021PbpkModelOfMetforminInHumansEightBiomd0000001029Model(TelluriumSBMLBioModule):
    """Faithfully executes the bundled SBML source for Zake2021 - PBPK model of metformin in humans, eight PO administrations with 12h interval."""

    _SBML_ID = 'BIOMD0000001029'
    _TITLE = 'Zake2021 - PBPK model of metformin in humans, eight PO administrations with 12h interval'
    ...
    def __init__(self, model_path: str = "data/BIOMD0000001029.xml", integration_step: float = 0.1) -> None:
