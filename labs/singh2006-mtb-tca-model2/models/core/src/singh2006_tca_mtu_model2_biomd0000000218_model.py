...
"""Tellurium-backed SBML BioModule for Singh2006_TCA_mtu_model2."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Singh2006TcaMtuModel2Biomd0000000218Model(TelluriumSBMLBioModule):
    """Faithfully executes the bundled SBML source for Singh2006_TCA_mtu_model2."""

    _SBML_ID = 'BIOMD0000000218'
    _TITLE = 'Singh2006_TCA_mtu_model2'
    ...
    def __init__(self, model_path: str = "data/BIOMD0000000218.xml", integration_step: float = 0.05) -> None:
